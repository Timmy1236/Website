...
const AboutMePage = {
  ...
  view() {
    return m(".content-column", [
      ...
      m(".panel", [
        ...
        m(".panel-content", [
          ...
          m(".social-buttons", [
            ...
            m("button.button", { onclick: () => window.open("https://github.com/Timmy1236", "_blank"), "data-tooltip": "github.com/Timmy1236" }, [
              m("img", { src: "./assets/images/icons/github.svg", alt: "GitHub" }),
              "GitHub"
            ]),
            m("button.button", { onclick: () => window.open("https://discordapp.com/users/375889010419171328", "_blank"), "data-tooltip": "@timmy1236" }, [
              m("img", { src: "./assets/images/icons/discord.svg", alt: "Discord" }),
              "Discord"
            ]),
            m("button.button", { onclick: () => window.open("https://steamcommunity.com/id/Timmy1236/", "_blank"), "data-tooltip": "STEAM_0:1:96376877" }, [
      ...
      // STATS
      m(".panel", [
        m(".panel-header", m("h1.text-title", "WakaTime")),
        m(".stats-content",
          m("embed", {
